                ...
                e
                    ? (a.each(t, function (a, S) {
                      ...
                      I.on("loaded.bs.select change", function (S) {
                          ...
                          var I = a(this)
                              .parent()
                              .find(".btn .filter-option.pull-left");
                          I.removeClass().addClass("filter-option pull-left"),
                              1 === n.length &&
                    ...
                    I.addClass("f16").html(i.join("\n"));
                var r = I.data("default");
                r &&
                    I.val(
