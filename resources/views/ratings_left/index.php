            ...
            <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <div class="card">
                        <div class="card-header">
                            <h5 class="main-heading"><?php echo trans('profile.ratings_left'); ?></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class='row'>
                                    <div class='col-12 col-md-6'>
                                        <h6 style="font-size:15px;">
                                            <?php echo trans('profile.i_reviewed'); ?>
                                        ...
                                        <ul class='ul__list'>
                                                ...
                                                <div class='d-flex'>
                                                    <div class='r-rateing mr-1'>
                                                        <div class='profile-rating' data-background='#808080'
                                                            ...
                                                            data-readonly='true' data-readonly='true' data-size='25px'>
                                                        </div>
                                                    </div>
                                                    <div class='r-text'>
                                                        <span>
                                            ...
                                            <li>
                                                <div class='d-flex'>
                                                    <div class='r-rateing mr-1'>
                                                        <div class='profile-rating' data-background='#808080'
                                                            data-rating='<?php echo $safety['avg']; ?>'
                                                            data-readonly='true' data-size='25px'></div>
                                                    </div>
                                                    <div class='r-text'>
                                                        <span>
                                        ...
                                        <?php 
                                                if(!empty($ratings)) {
                                                    foreach($ratings as $rating) {
                                                        ...
                                                        if($rating['rating']->type=='2') $link='passenger/';
                                                        else $link='driver/';
                                                ?>
                                            ...
                                            <div class='media mb-4'>
                                                ...
                                                <div class='media-body pt-3'>
                                                    <h6 class='r-title mb-0'>
                                                        ...
                                                        <?php
                                                                    if($rating['rating']->type=='1') echo '<small> • Driver review</small>';
                                                                    else echo '<small> • Passenger review</small>';
                                                                ?>
                                                    </h6>
