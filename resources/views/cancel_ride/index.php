...
<input id='recurr2' type='checkbox' value='<?php echo $ride[0]['ride']->id; ?>' name="cancel_recurring">
...
Cancel all recurring rides
    ...
    <button type="submit" class="btn btn-primary mt-4" id="book_btn">Yes I want to cancel the ride</button>
    <a href="<?php echo url('ride/'.$ride[0]['ride']->url); ?>">
    <button type="button" class="btn btn-secondary mt-4">I do not want to cancel the ride</button>
    </a>
</div>
