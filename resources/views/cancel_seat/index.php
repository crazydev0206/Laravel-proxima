...
<!---->    </tbody>
    ...
    ?>
    <p class="alert alert-success mb-0"><i class="fa fa-info-circle"></i> You will get full refund of your payment on ride cancellation with booking fee.</p>
    <?php } else if($hours12_before>=date('Y-m-d H:i:00')) {
    ?>
    <p class="alert alert-success mb-0"><i class="fa fa-info-circle"></i> You will get half refund of your payment on ride cancellation without booking fee.</p>
    <?php } else {
    ?>
    <p class="alert alert-danger mb-0"><i class="fa fa-exclamation-triangle"></i> You will get no refund of your payment on ride cancellation.</p>
    <?php } ?>
    
    <button type="submit" class="btn btn-primary mt-4" id="book_btn">Cancel seat</button>
</div>
...
<script>
    ...
    {
        var seat=$(th).val();
        var price='<?php echo $ride[0]['ride']->price; ?>';
        var booking_price='<?php echo $booking_price; ?>';
        price=(parseFloat(price)*seat)+parseFloat(booking_price);
