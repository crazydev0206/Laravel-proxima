...
<div class='container'>
<h3 class='page-title bottom-border mb-3 pb-1'><?php echo trans('pages.passengers', [], $languageSet) ?></h3>
<div class='row pt-3'>
    
    <div class='col-md-6 col-lg-6'>
        <h6 style="font-weight: 500 !important;"><?php echo trans('pages.passengers_title', [], $languageSet) ?></h6>
        
        <p class="text-justify"><?php echo trans('pages.passengers_text1', [], $languageSet) ?></p>
        
        <p class="text-justify"><?php echo trans('pages.passengers_text2', [], $languageSet) ?></p>
        
        <p class="text-justify"><?php echo trans('pages.passengers_text3', [], $languageSet) ?></p>
    </div>
