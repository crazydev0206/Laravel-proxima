...
<b><?php echo \CommonFunctions::instance()->rides_driven($user_data->id); ?></b>
</p>
</li>
<li>
<p class='mb-0'>
...
<p class='mb-0'>
Passengers driven:
<b><?php echo \CommonFunctions::instance()->pass_driven($user_data->id); ?></b>
</p>
</li>
<li class="d-none">
<p class='mb-0'>
...
<div class='d-flex'>
<div class='r-rateing mr-1'>
<div class='profile-rating' data-background='#808080' data-rating='<?php echo $vehicle_condition; ?>' data-readonly='true' data-size='25px'></div>
</div>
<div class='r-text'>
<span>
...
<div class='d-flex'>
<div class='r-rateing mr-1'>
<div class='profile-rating' data-background='#808080' data-rating='<?php echo $conscious; ?>' data-readonly='true' data-size='25px'></div>
</div>
<div class='r-text'>
<span>
...
<div class='d-flex'>
<div class='r-rateing mr-1'>
<div class='profile-rating' data-background='#808080' data-rating='<?php echo $comfort; ?>' data-readonly='true' data-size='25px'></div>
</div>
<div class='r-text'>
<span>
Comfort
...
<h6 class='r-title mb-0'><a href="<?php echo url('passenger/'.$rating['user']->username); ?>"><?php echo $user_name; ?></a></h6>
