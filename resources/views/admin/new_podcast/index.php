          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px;" id="add_new">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label>Podcast Name <font style="color:red;">*</font></label>
                      <input type="text" class="form-control" name="name2" required>
                </div>
                  
                  <div class="form-group">
                  <label>RSS URL <font style="color:red;">*</font></label>
                      <input type="url" class="form-control" name="sku_number" required>
                </div>
                  ...
                  <label>Set Image <font style="color:red;">*</font></label>
                      <input type="file" class="form-control" name="profile2" required>
                </div>
