...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM discount_categories WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    if(isset($_POST['name2'])) {
      ...
      $q="INSERT INTO discount_categories (name) VALUES ('$name')";
...
$q="SELECT * FROM discount_categories ORDER BY id DESC";
$r=@mysqli_query($dbc,$q);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../discount_categories/">Discount Categories</a></li>
      </ol>
    </section>
