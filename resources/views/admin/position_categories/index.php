...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM position_categories WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    if(isset($_POST['name'])) {
      ...
      $q="INSERT INTO position_categories (name, p_id) VALUES ('$name', '$p_id')";
...
if(empty($error2)) {
      ...
      $q="INSERT INTO position_categories (name) VALUES ('$name')";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $p_id=mysqli_insert_id($dbc);
          $error2= '<font style="color:green; font-weight:bold;">Category added successfully.</font>';
...
$q="SELECT * FROM position_categories ORDER BY id DESC";
$r=@mysqli_query($dbc,$q);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../position_categories/">Position Categories</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px; display:none;" id="add_new">
              <div class="box-body">
                  ...
                  <label>Under Position Type <font style="color:red;">*</font></label>
                      <select class="form-control" name="p_id" required>
                          <option value=""></option>
                          <?php 
    $q2="SELECT id, name FROM position_type";
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                      <a href="../position_sub/?id=<?php echo $row['id']; ?>"><button class="btn btn-success">Sub Categories</button></a>
