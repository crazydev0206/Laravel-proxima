...
if(empty($error2)) {
      ...
      $q="INSERT INTO discounts (title, description, category, link, logo) VALUES ('$title','$description', '$category', '$link', '$name_image')";
    ...
    if(@mysqli_num_rows($rc)!=0) {
        while($rowc=@mysqli_fetch_assoc($rc)) {
            ...
            <?php
                  ...
                  <div class="form-group">
                  <label>Logo <font style="color:red;">*</font></label>
