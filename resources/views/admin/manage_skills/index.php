...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM skills WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    $name=test_input($_POST['name']);
      ...
      $q="INSERT INTO skills (name) VALUES ('$name')";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $p_id=mysqli_insert_id($dbc);
          $error2= '<font style="color:green; font-weight:bold;">Skill added successfully.</font>';
      }
    }
...
$q="SELECT * FROM skills ORDER BY id ASC";
$r=@mysqli_query($dbc,$q);
...
include(APPPATH.'views/admin/common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Skills
        <small><?php echo @mysqli_num_rows($r); ?> total skills</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="../manage_skills/">Manage Skills</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
              ...
              <button class="btn btn-success" style="float:right;" onclick="add_new()">+ New Skill</button>

          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px; display:none;" id="add_new">
              <div class="box-body">
                  
                  <div class="form-group">
                  <label>Skill Name <font style="color:red;">*</font></label>
