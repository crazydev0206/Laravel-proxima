...
if(empty($error2)) {
      ...
      $q="INSERT INTO news (title, article, image, posted_on) VALUES ('$title','$article', '$name_image', NOW())";
  ...
  <div class="content-wrapper">
    ...
    //}
                  ...
                  <label>Write News <font style="color:red;">*</font></label>
                      <textarea class="textarea form-control" rows="6" name="article" required></textarea>
                </div>
