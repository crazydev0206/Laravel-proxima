...
include('../common/connect.php');
    if(!isset($_GET['id'])) {
?>
<script> window.location="../all_products/"; </script>
<?php
}
...
if(empty($error2)) {
      ...
      $q="UPDATE products SET image='$name_image' WHERE id='$id'";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $error2= '<font style="color:green; font-weight:bold;">Product updated successfully.</font>';
      }
...
$error2='There is an error. Try Later.<br>';
    ...
    // END
      ...
      $q="UPDATE products SET category='$category', title='$title', description='$description', url='$url', price='$price' WHERE id='$id'";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $error2= '<font style="color:green; font-weight:bold;">Product updated successfully.</font>';
      } 
              ...
              <div class="box-body">
                <div class="form-group">
                            ...
                            <select class="form-control" id="exampleSelect1" required name="category">
                                <option value=""></option>
                              <?php 
                                $q="SELECT name, id FROM market_categories";
                                $r=@mysqli_query($dbc,$q);
                                if(@mysqli_num_rows($r)!=0) {
                          ...
                          <div class="form-group">
                            ...
                            <!--<div class="form-group">
                            <label for="exampleInputEmail1">Regular Price <font style="color:red;">*</font></label>
                            <input class="form-control" aria-describedby="emailHelp" type="number" required name="regular_price" min="0" placeholder="$">
                          </div>-->
                            <div class="form-group">
                            <label for="exampleInputEmail1">Price <font style="color:red;">*</font></label>
                            <input class="form-control" aria-describedby="emailHelp" type="number" required name="price" min="0" placeholder="$" value="<?php echo $row['price']; ?>">
                          </div>
                            <!--<div class="form-group">
                            <label for="exampleInputEmail1">Buy Link <font style="color:red;">*</font></label>
                            <input class="form-control" aria-describedby="emailHelp" type="url" required name="url">
                          </div>-->
                            <div class="form-group">
