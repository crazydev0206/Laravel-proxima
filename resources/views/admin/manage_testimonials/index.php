...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM testimonials WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    if(isset($_POST['name2'])) {
      ...
      $q="INSERT INTO market_categories (name) VALUES ('$name')";
...
include(APPPATH.'views/admin/common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Testimonials
        <small><?php echo @mysqli_num_rows($r); ?> total feedbacks</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="../manage_testimonials/">Manage Testimonials</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px; display:none;" id="add_new">
              <div class="box-body">
                  ...
                  <div class="form-group">
                  <label>Set Image <font style="color:red;">*</font></label>
                      <input type="file" class="form-control" name="profile" required accept="image/*">
                </div>
                  
                  <div class="form-group">
                  <label>Feedback <font style="color:red;">*</font></label>
                      <textarea class="form-control" name="feedback" required accept="image/*"></textarea>
                </div>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url(); ?>assets/testimonials_images/<?php echo $row['image']; ?>" style="max-width:100px; max-height:100px;"></td>
