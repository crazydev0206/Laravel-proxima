...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM pdfs WHERE id='$v_id'";
...
//echo $error2;
  if(empty($error2)) { //echo 'in';
      ...
      $q="INSERT INTO pdfs (name,file,p_id) VALUES ('$title','$name_image', '$id')";
...
$q="SELECT * FROM pdfs WHERE p_id='$id'";
$r=@mysqli_query($dbc,$q);
...
include('../common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        PDFs for "<?php echo $row2['name']; ?>"
        <small><?php echo @mysqli_num_rows($r); ?> total pdf</small>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row['name']; ?></td>
                    <td>
                        <a href="../../pdfs/<?php echo $row['file']; ?>" target="_blank"><?php echo $row['file']; ?></a>
                    </td>
                  <td>
                    <form action="" method="post">
                    <input type="hidden" name="item_id" value="<?php echo $row['id']; ?>">
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Do you really want to delete this pdf?');">Delete</button>
                  </form>
                  </td>
                </tr>
                <?php } } ?>
