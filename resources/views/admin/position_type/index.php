...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM position_type WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    if(isset($_POST['name'])) {
      ...
      $q="INSERT INTO position_type (name) VALUES ('$name')";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $p_id=mysqli_insert_id($dbc);
          $error2= '<font style="color:green; font-weight:bold;">Added successfully.</font>';
      }
    }
...
$q="SELECT * FROM position_type ORDER BY id DESC";
$r=@mysqli_query($dbc,$q);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../position_type/">Position Type</a></li>
      </ol>
    </section>
