  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/verify-drivers'); ?>">Verify drivers</a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row['user']->email; ?>
                    ...
                    <td><a href="<?php echo url('driver_license/'.$row['user']->driver_license); ?>" target="_blank"><?php echo $row['user']->driver_license; ?></a></td>
                    <td><?php 
                            if($row['user']->driver=='0') echo 'Information not provided';
                            else if($row['user']->driver=='1') echo 'Accepted';
                            else if($row['user']->driver=='3') echo 'Rejected';
                            else if($row['user']->driver=='2') echo 'Under Review';
                        ?></td>
                  <td>
