...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM tags WHERE id='$v_id'";
...
include('../common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        All Tags
        <small><?php echo @mysqli_num_rows($r); ?> total tags</small>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Do you really want to delete this tag?');">Delete</button>
                  </form>
                  </td>
                </tr>
                <?php } } ?>
