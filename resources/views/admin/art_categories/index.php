...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM art_categories WHERE id='$cat_id'";
...
$q="SELECT * FROM art_categories ORDER BY id DESC";
$r=@mysqli_query($dbc,$q);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../art_categories/">All Categories</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px; display:none;" id="add_new">
              <div class="box-body">
                  ...
                  <div class="form-group">
                  <label>Short Description <font style="color:red;">*</font></label>
