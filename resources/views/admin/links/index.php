...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM links WHERE id='$v_id'";
  ...
  if(isset($_POST['name'])) {
      ...
      $q="INSERT INTO links (name,url,video_id) VALUES ('$name','$url','$id')";
  ...
  if($imageFileType != "application/msword" && $imageFileType != "application/vnd.openxmlformats-officedocument.wordprocessingml.document" && $imageFileType != "application/rtf"
  && $imageFileType != "pdf") { 
  $error2= '<font style="color:red; font-weight:bold;">File type should be .pdf.</font>';
  $uploadOk = 0;
  }
...
//echo $error2;
  if(empty($error2)) { //echo 'in';
      ...
      $q="INSERT INTO pdfs (title,description,file,video_id) VALUES ('$title','$description','$name_image','$id')";
      $r=@mysqli_query($dbc,$q) or die();
...
$q="SELECT * FROM links WHERE video_id='$id'";
$r=@mysqli_query($dbc,$q);
...
include('../common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Links for "<?php echo $row2['title']; ?>"
        <small><?php echo @mysqli_num_rows($r); ?> total links</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="../pdfs/?id=<?php echo $id; ?>">All pdfs</a></li>
      </ol>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Do you really want to delete this link?');">Delete</button>
                  </form>
                  </td>
                </tr>
                <?php } } ?>
