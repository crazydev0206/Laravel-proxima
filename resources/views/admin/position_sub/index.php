...
include('../common/connect.php');
    ...
    if(!isset($_GET['id'])) {
?>
<script> window.location="../position_categories/"; </script>
<?php
}
...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM position_sub WHERE id='$cat_id'";
  $r=@mysqli_query($dbc,$q);
    ...
    if(isset($_POST['name'])) {
      ...
      $q="INSERT INTO position_sub (name, c_id) VALUES ('$name', '$id')";
...
$q="SELECT * FROM position_categories WHERE id='$id' LIMIT 1";
$r=@mysqli_query($dbc,$q);
...
include('../common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <b>"<?php echo $row['name']; ?>"</b> Position Sub-Categories
        <small><?php 
    $q="SELECT * FROM position_sub WHERE c_id='$id'";
    $r=@mysqli_query($dbc,$q);
    echo @mysqli_num_rows($r); ?> total categories</small>
      </h1>
      <ol class="breadcrumb">
