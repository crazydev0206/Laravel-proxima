...
if($_SERVER['REQUEST_METHOD']=='POST' AND 0) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../all_articles/">All Articles</a></li>
      </ol>
    </section>
    ...
    //}
                  ...
                  <div class="form-group">
                  <label>Set Thumbnail <font style="color:red;">*</font></label>
                      <input type="file" class="form-control" name="profile" required>
                </div>
                  
                  <div class="form-group">
                  <label>Set Categories <font style="color:red;">*</font></label>
                      <select name="categories" class="form-control" required>
            <?php
    $qt="SELECT name FROM skills ORDER BY name";
                                    $rt=@mysqli_query($dbc,$qt);
                                    if(@mysqli_num_rows($rt)!=0) { $i=0;
    ...
    ?>
                  ...
                  <div class="form-group">
                  <label>Write Article <font style="color:red;">*</font></label>
                      <textarea class="textarea form-control" rows="6" name="description" required></textarea>
                </div>
