...
include('../common/connect.php');
    ...
    if(!isset($_GET['id'])) {
?>
<script> window.location="../all_news/"; </script>
<?php
}
...
if(empty($error2)) {
      ...
      $q="UPDATE news SET image='$name_image' WHERE id='$id'";
...
$error2='There is an error. Try Later.<br>';
    ...
    if(isset($_POST['title'])) {
      ...
      $q="UPDATE news SET title='$title', article='$article' WHERE id='$id'";
      $r=@mysqli_query($dbc,$q) or die(mysqli_error($dbc));
      if($r) {
          $error2= '<font style="color:green; font-weight:bold;">Updated successfully.</font>';
      }
...
include('../common/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    //}
                  ...
                  <div class="form-group">
                  <label>Write News <font style="color:red;">*</font></label>
                      <textarea class="textarea form-control" rows="6" name="article" required><?php echo $row['article']; ?></textarea>
                </div>
