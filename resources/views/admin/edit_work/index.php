...
if($_SERVER['REQUEST_METHOD']=='POST') {
  if(isset($_POST['name'])) {
      ...
      $q="UPDATE works SET name='$name', description='$description' WHERE id='$id'";
...
$last2=rand(pow(10, 4-1), pow(10, 4)-1);
      ...
      if(empty($error2)) {
        ...
        $q="INSERT INTO work_images (name,w_id) VALUES ('$name_image','$id')";
...
$flag=1;
    ...
    $flag=0; }
        ...
        $q="SELECT * FROM works WHERE id='$id' LIMIT 1";
        ...
        <div class="col-xs-12">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px;" id="add_new">
              <div class="box-body">
                  ...
                  <div class="form-group">
                  <label>Add Images <font style="color:red;">*</font></label>
