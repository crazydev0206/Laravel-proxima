...
$flag=1;
    ...
    $top=test_input2($_POST['for_top']);
    $q="UPDATE texts SET text='$top' WHERE forr='for_top'";
    $r=@mysqli_query($dbc,$q);
    
    $top=test_input2($_POST['for_terms']);
    $q="UPDATE texts SET text='$top' WHERE forr='for_terms'";
    $r=@mysqli_query($dbc,$q);
        ...
        <div class="col-xs-12">
          ...
          <form role="form" action="" method="post" enctype="multipart/form-data" style="margin-top:5px;" id="add_new">
              <div class="box-body">
                  ...
                  <label>Top Section<font style="color:red;">*</font></label>
                      <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="for_top" required><?php echo $top; ?></textarea>
                </div>
                  
                  <div class="form-group">
                  <label>Terms of Use <font style="color:red;">*</font></label>
                      <textarea class="form-control textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" rows="9" name="for_terms" required><?php echo $terms; ?></textarea>
                </div>
