...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $q="DELETE FROM market_categories WHERE id='$cat_id'";
...
$q="SELECT * FROM market_categories ORDER BY id DESC";
$r=@mysqli_query($dbc,$q);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../market_categories/">Marketplace Categories</a></li>
      </ol>
    </section>
