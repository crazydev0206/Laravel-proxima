  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/pending-users'); ?>">Pending Users</a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row['user']->email; ?>
                    ...
                    <td><?php 
                            if($row['user']->status=='0') echo 'Information not provided';
                            else if($row['user']->status=='1') echo 'Accepted';
                            else if($row['user']->status=='3') echo 'Rejected';
                            else if($row['user']->status=='2') echo 'Waiting for Review';
                        ?></td>
                  <td>
